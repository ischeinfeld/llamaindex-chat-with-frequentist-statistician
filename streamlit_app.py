...
st.title("Chat with a Frequentist Statistician")
st.write(
...
if not openai_api_key:
    ...
    if "messages" not in st.session_state.keys():  # Initialize the chat messages history
        st.session_state.messages = [
            {"role": "assistant", "content": "I am a frequentist statistician, here to assist you. You can ask me about frequentist statistics and statistical testing."}
        ]
